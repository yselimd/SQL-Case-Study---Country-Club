...
LEFT JOIN Members
USING(memid)
WHERE starttime LIKE '2012-09-14%' AND (CASE WHEN memid=0 THEN guestcost
...
SELECT f.name,COUNT(b.memid) AS Bookings
FROM Bookings AS b
